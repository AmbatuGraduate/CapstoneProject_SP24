...
import { GARBAGE_COLLECTION_SCHEDULE, useApi, GARBAGE_COLLECTION_DELETE, EMPLOYEE_LIST, GARBAGE_COLLECTION_DETAIL, GARBAGE_COLLECTION_UPDATE } from "../../Api";
...
export const ManageGarbageCollectionSchedule = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await useApi.get(GARBAGE_COLLECTION_DETAIL.replace(":id", selectedRowId));
      ...
      // @ts-ignore or @ts-expect-error
      await useApi.post(GARBAGE_COLLECTION_UPDATE.replace(":id", selectedRowId), updatedRowData);
